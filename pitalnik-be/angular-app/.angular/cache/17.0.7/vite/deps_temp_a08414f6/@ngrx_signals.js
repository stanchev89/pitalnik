...
function excludeKeys(obj, keys) {
  return Object.keys(obj).reduce((acc, key) => keys.includes(key) ? acc : __spreadProps(__spreadValues({}, acc), {
    [key]: obj[key]
  }), {});
}
  ...
  return (store) => {
    const createHook = (name) => {
      ...
      return hook ? () => {
        ...
        hook(__spreadValues(__spreadValues(__spreadValues({
